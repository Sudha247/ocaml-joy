...
(*
   Complex shapes can be created from lists of shapes.
   This allows us to apply any of the library's transformations to a group of
...
(* creates a list of (int * int) tuples,
   containing every combination of the elements of the two passed lists *)
